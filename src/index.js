			...
			[
...

				{
					...
					onStart: async () =>
					{
						...
						// ]
						[
							{ meatman: 'Marinade_Wrong01', sauce_a: meshes['models/Vinegar.glb'].animations['Sauces_Vinegar'] },
							{ meatman: 'Marinade_Wrong02', sauce_a: meshes['models/Mayonnaise.glb'].animations['Sauces_Mayonnaise'] },
							{ meatman: 'Marinade_Wrong03', sauce_a: meshes['models/SoySauce.glb'].animations['Sauces_SoySauce'] },
						]
							.forEach(
					...
					onUpdate: () =>
					{
						...
						meshes['models/Mayonnaise.glb'] && meshes['models/Mayonnaise.glb'].mixer.update(clock_delta);
						meshes['models/SoySauce.glb'] && meshes['models/SoySauce.glb'].mixer.update(clock_delta);
						meshes['models/Vinegar.glb'] && meshes['models/Vinegar.glb'].mixer.update(clock_delta);
